...
export default function Navbar() {
  ...
  return (
    <div id="header" className=" w-full top-0 text-black bg-gray-800">
      <div className="w-full flex flex-wrap justify-center md:justify-end h-full py-2 md:py-4">
        <div className="flex items-center md:items-end">
          <a
            className="toggleColour text-gray-200 no-underline hover:no-underline font-bold text-xl lg:text-2xl"
            href="#"
          >
